...
ubmat <- matrix(ncol=3,byrow=TRUE,
                c(mean(res$chains$p_11)+1.96*sd(res$chains$p_11),
                  mean(res$chains$p_12)+1.96*sd(res$chains$p_12),
                  mean(res$chains$p_13)+1.96*sd(res$chains$p_13),
                  mean(res$chains$p_21)+1.96*sd(res$chains$p_21),
                  mean(res$chains$p_22)+1.96*sd(res$chains$p_22),
                  mean(res$chains$p_23)+1.96*sd(res$chains$p_23),
                  mean(res$chains$p_31)+1.96*sd(res$chains$p_31),
                  mean(res$chains$p_32)+1.96*sd(res$chains$p_32),
                  mean(res$chains$p_33)+1.96*sd(res$chains$p_33))
                )
