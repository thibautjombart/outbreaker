...
\begin{eqnarray*}
p(s_i^k | S_i, S_j, i \leftarrow j) & = & \alpha \times (\Xi_{s_i^k}^{(1)} + \Xi_{s_i^k}^{(2)}) + (1 - \alpha) \times (\Xi_{s_i^k}^{(3)} + \Xi_{s_i^k}^{(4)})\\
\end{eqnarray*}
where $\Xi_{s_i^k}^{(1)}$ and $\Xi_{s_i^k}^{(2)}$ respectively correspond to direct ancestries from sequences in $S_j$ and $S_i$, while $\Xi_{s_i^k}^{(3)}$ and $\Xi_{s_i^k}^{(4)}$ respectively correspond to indirect ancestries with sequences in $S_j$ and $S_i$.
These are given by:
\begin{eqnarray*}
...
\Xi_{s_i^k}^{(2)} & = & \sum_{r=1}^{m_i} \left(\mathcal{P}\left(d_{s_i^k,s_i^r} | \nu_1 \mathbf{1}_{\{t_i^k > t_i^r\}}(t_i^k - t_i^r) l_{s_i^k,s_i^r}\right)
...
\Xi_{s_i^k}^{(4)} & = & \sum_{r=1}^{m_i} \left(\mathcal{P}\left(d_{s_i^k,s_i^r} | \nu_1 (|t_i^k - t_i^r| + 2\tau) l_{s_i^k,s_i^r}\right)
...
\begin{eqnarray*}
p(S_i | S_j, i \leftarrow j) & = & \prod_{k=1}^{m_i} p(s_i^k | S_i, S_j, i \leftarrow j) \\
\end{eqnarray*}
