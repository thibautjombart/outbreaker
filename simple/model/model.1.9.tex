...
\begin{itemize}
	...
	\item $p(\pi) = \beta(a,b)$: the proportion of observed cases is assumed to follow a Beta distribution of fixed parameters (e.g. $p(\pi) = \beta(10,1)$ for an a priori densely sampled outbreak.
\end{itemize}
