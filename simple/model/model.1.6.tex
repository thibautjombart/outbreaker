...
\item the probability of observing infection from the outside is constant over time
...
We note $\kappa = \{\kappa_2, \ldots, \kappa_n\}$.
	...
	\item $\phi$: the probability that a case has been seeded by an external source.
\end{itemize}
...
\begin{eqnarray}
& & p(\{s_i, t_i, T_i^{inf}\}_{(i=1,\ldots,n)}|  w,  \alpha, \kappa, \mu_1, \gamma, \phi) \\
& = & \prod_{i=2}^n p(s_i, t_i, T_i^{inf} | \{s_k, t_k, T_k^{inf} \}_{(k=1,\ldots,i-1)}, w,  \alpha, \kappa, \mu_1, \gamma, \phi) 
  \times p(s_1, t_1, T_1^{inf}|w, \phi)\\
& = & \prod_{i=2}^n p(s_i, t_i, T_i^{inf}| s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi) 
  \times p(s_1, t_1 , T_1^{inf}|w, \phi)\\
& = & \prod_{i=2}^n p(s_i, t_i, T_i^{inf}| s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi) 
  \times p(t_1 | T_1^{inf},w) p(T_1^{inf}) p(s_1) p(\phi)
\end{eqnarray}
...
$p(\phi)$ is the probability of observing an index case.
...
\begin{equation}
 p(s_i, t_i, T_i^{inf}| s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi)
\end{equation}
which can be decomposed into:
\begin{eqnarray}
& & p(s_i | t_i, T_i^{inf}, s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi) \nonumber \\
& &  \times  p(t_i | T_i^{inf}, s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi) \nonumber \\
& & \times  p(T_i^{inf}| s_{\alpha_i}, t_{\alpha_i}, T_{\alpha_i}^{inf},  w,  \alpha_i, \kappa_i, \mu_1, \gamma, \phi) \nonumber \\
