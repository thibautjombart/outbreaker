...
double ObsLevelPerCase (int i, raw_data * data, nb_data *nb, aug_data *augData, parameters * param) /* observation level for patient i */
{
	int j,k;
...
double ObsLevel (raw_data * data, nb_data *nb, aug_data *augData, parameters * param) /* observation level for all patients */
{
	int i;
	double L = 0;
