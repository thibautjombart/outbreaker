...
\left(
\left( \mathbf{1}_{\left\lbrace P_i^*[j] < C_i \right\rbrace}+\mathbf{1}_{\left\lbrace P_i^*[j] \geq E_i \right\rbrace} \right) \times \left(1-\psi\right) % false positive
+ \mathbf{1}_{\left\lbrace C_i \leq P_i^*[j] < E_i \right\rbrace} \times \phi % true positive
\right) \\ 
& & \bm{\prod}_{k=1}^{n_i^*} % negative tests
\left(
\left( \mathbf{1}_{\left\lbrace N_i^*[k] < C_i \right\rbrace}+\mathbf{1}_{\left\lbrace N_i^*[k] \geq E_i \right\rbrace} \right) \times \psi % true negative
+ \mathbf{1}_{\left\lbrace C_i \leq N_i^*[k] < E_i \right\rbrace} \times \left(1-\phi\right) % false negative
\right) \\ 
...
& \propto & \bm{\prod}_{t=1}^T \bm{\prod}_{w=1}^2 P\left(I_w\left(t\right)|\left\{E_i,C_i,w_i,k_i,A_i,D_i\right\}_{i=1\ldots,N/C_i\leq t},\bm{\theta}\right) \bm{\prod}_{i=1}^N \mathbf{1}_{\left\lbrace C_i = t \right\rbrace} \\ % individuals colonised at time t
