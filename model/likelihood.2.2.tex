...
The genetic likelihood given the infection $i \leftarrow j$ relies on how likely it is that a sequence in $S_i$ has its closest direct ancestor in $S_i$ or $S_j$.
