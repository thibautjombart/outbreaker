...
void moveBeta(int i, int j, mcmcInternals * MCMCSettings, parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept, NbProposals *NbProp)
{
	...
	*(newVal) = *(curVal)*gsl_ran_lognormal(rng,0,sigmaProp);
...
void moveBetaOut( char what, mcmcInternals * MCMCSettings, parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept, NbProposals *NbProp)
{
...
void moveSp(parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept)
{
	...
	//curParam->Sp = gsl_ran_beta (rng, NbTrueNeg+1, NbFalsePos+1);
}
...
void moveSe(parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept)
{
	...
	curParam->Se = gsl_ran_beta (rng, NbTruePos+1, NbFalseNeg+1);
}
...
void movePi(parameters * curParam, raw_data * data, aug_data *augData, acceptance *accept)
{
	...
	curParam->Pi = gsl_ran_beta (rng, ColonisedAtFirstAdmission+1, NonColonisedAtFirstAdmission+1);
}
...
void moveMutationRate(int what, mcmcInternals * MCMCSettings, parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept, NbProposals *NbProp)
{
...
void moveTau(mcmcInternals * MCMCSettings, parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept, NbProposals *NbProp)
{
...
void moveAlpha(mcmcInternals * MCMCSettings, parameters * curParam, raw_data * data, nb_data *nb, aug_data *augData, acceptance *accept, NbProposals *NbProp)
{
...
void moveC(int i, mcmcInternals * MCMCSettings, parameters * param, raw_data * data, nb_data *nb, aug_data *curAugData)
{
	...
	random=gsl_rng_uniform_int (rng, curNbPoss);
...
void moveCandE(int i, mcmcInternals * MCMCSettings, parameters * param, raw_data * data, nb_data *nb, aug_data *curAugData)
{
	...
	random=gsl_rng_uniform_int (rng, 2*l);
